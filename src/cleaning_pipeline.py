...
def data_cleaning(df):
    ...
    df["CountMailsInConversation"] = [
        len(re.findall("Sent: .* :To:", str(df["LastIncomingEmailContent"][i])))
    ...
    df.to_csv(
        "/Users/victor/Documents/Confidential Dataset/ML_NOAC_NOVA_Extraction_Cleaned_FinalCleaned.csv",
        index=False,
    )
...
def split_emails(text):
    ...
    # remove non english words from string
